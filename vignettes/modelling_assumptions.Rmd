...
This document describes the nature of the open source covid-19 mental health surge model developed by the [Strategy Unit][su]. The model code can be found on [GitHub][gh] and the interactive shiny app can be found [here][app]. 
