...
#'
#' @param model_ouput output from \code{run_model()} and \code{get_model_output()}
...
#' @param treatment a vector of treatments to include in the graph, defaults to all treatments
#'
#' @return a plotly chart
#'
#' @import rlang
